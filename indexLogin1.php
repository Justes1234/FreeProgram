    ...
    <div id="block">
        ...
        <div id="blocks" style="text-align: center;">
            <h1 style="color:white">
                ...
                <div class="transfer13"><a href="/pages2/adobePhotoshop.html" class="button8">Детальніше</a></div>
        </div>
        ...
        <div id="block2">
            ...
            <div id="blocks2" style="text-align: center;">
                <h1 style="color:white">
                    ...
                    <div class="transfer14"><a href="/pages2/adobePremierePro.html" class="button8">Детальніше</a></div>
            </div>
            ...
            <div id="block3">
                ...
                <div id="blocks3" style="text-align: center;">
                    <h1 style="color:white">
                        ...
                        <div class="transfer15"><a href="/pages2/Adobe Audition.html" class="button8">Детальніше</a>
                        </div>
                </div>
