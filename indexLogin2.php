...
<div class="hat">
    ...
    <div class="transfer4">
        <a href="profile.php" class="button8">Профіль</a>
    </div>
    <div class="transfer5">
        <a href="vendor/logout.php" class="button8">Вихід</a>
    </div>
    <div class="transfer6">
    ...
    <div id="block">
        ...
        <div id="blocks" style="text-align: center;">
            <h1 style="color:white">
                ...
                <div class="transfer13"><a href="/pages2/adobeAfterEffects.html" class="button8">Детальніше</a></div>
        </div>
        ...
        <div id="block2">
            ...
            <div id="blocks2" style="text-align: center;">
                <h1 style="color:white">
                    ...
                    <div class="transfer14"><a href="/pages2/sonyVegasPro.html" class="button8">Детальніше</a></div>
            </div>

            <div id="block3">
                <img src="images/06.png" width="300" height="300" alt="">
                <div id="blocks3" style="text-align: center;">
                    <h1 style="color:white">
                        <?php

                        $query = mysqli_query($connection, "SELECT * FROM programs WHERE id='6'");
                        ...
                        <div class="transfer15"><a href="/pages2/Bandicam.html" class="button8">Детальніше</a>
                        </div>
                </div>
                ...
                <div class="Category2">
                    ...
                    <div class="transfer7">
                        <a href="indexLogin1.php" class="button8">⮘⮘</a>
                    </div>
                    <div class="transfer8">
                        <a href="indexLogin1.php" class="button8">⮘</a>
                    </div>
                    <div class="transfer9">
                        <a href="indexLogin1.php" class="button8">1</a>
                    </div>
                    <div class="transfer10">
                        <a href="indexLogin2.php" class="button8">2</a>
                    </div>
                    <div class="transfer11">
                        <a href="indexLogin2.php" class="button8">⮚</a>
                    </div>
